# Generated by Powerlevel10k configuration wizard on 2026-04-03 at 14:05 CEST.
# Manuallz edited on 2026-04-06.
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=147
  # Custom icon.
  ...
  ##################################[ dir: current directory ]##################################
  # pwd prompt background
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=237 # dark grey
  # pwd main text color
  ...
  # Color of the shortened directory text.
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=140 # pinkish purple
  # Color of the anchor directory text.
  # Anchors never shorten.
  # The first segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=147 # lavender
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=147
  ...
  # this one is more like vertical bar with arrow peaking out
  ...
  typeset -g POWERLEVEL9K_STATUS_OK=false # if it doesnt show, ik its ok anyway
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND=236 # grey
